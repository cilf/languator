...
WYMeditor.editor.prototype.replaceStrings = function(sVal) {
    ...
    if(!WYMeditor.STRINGS[this._options.lang]) {
        try {
            eval(jQuery.ajax({
                url:this._options.langPath +
                this._options.lang + '.js', 
                async:false
            }).responseText);
        } catch(e) {
...
//        }
//        
//        var endNode = node.childNodes.item(count); 
//        
//        if(endNode){
//            c(html);
//            var endOffset = node.childNodes.item(count).length; 
//            c(endOffset);
//            range.setEnd(endNode,endOffset); 
//            range.setStart(endNode,endOffset); 
//            selection.removeAllRanges(); 
//            selection.addRange(range); 
//    //        clean(node,"font-size:", true); 
//    //        tidy(newnodeNode); 
...
WYMeditor.editor.prototype.loadSkin = function() {
    ...
    if(this._options.initSkin && !WYMeditor.SKINS[this._options.skin]) {
        ...
        eval(jQuery.ajax({
            url:this._options.skinPath +
            WYMeditor.SKINS_DEFAULT_JS, 
            async:false
        }).responseText);
    }
