    ...
    if(navigator.appName=="Microsoft Internet Explorer"){
        ...
        for(a=0;a<obj.length;a++){
            ...
            b.onmouseup=function(){
                ...
                for(var c=0;c<obj.length;c++)if(obj[c]==b)break;b.focus();
...
jQuery.fn.extend({
    getSelection:function(){
        ...
        if(document.selection){
            ...
            for(c=0;c<a.length;c++)if(a[c]==b)break;if(b.value.match(/\n/g)!=null)h=b.value.match(/\n/g).length;
            if(d.text){
                e=d.text;
...
replaceSelection:function(b){
    ...
    for(var k=0;k<c.length;k++)if(c[k]==a)break;if(document.selection&&typeof a.selectionStart!="number"){
...
insertAtCaretPos:function(b){
    ...
    for(var j=0;j<i.length;j++)if(i[j]==a)break;a.focus();
...
setCaretPos:function(b){
    ...
    for(var f=0;f<d.length;f++)if(d[f]==a)break;a.focus();
